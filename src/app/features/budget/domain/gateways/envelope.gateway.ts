...
export abstract class EnvelopeGateway {
  ...
  abstract updateBalance(id: string, amount: number, date: string, note: string | null, envelope: Envelope): Observable<Envelope>;
  abstract getTransactions(envelopeId: string): Observable<EnvelopeTransaction[]>;
  abstract getAllTransactions(): Observable<EnvelopeTransaction[]>;
  abstract addTransaction(envelopeId: string, data: { amount: number; date: string; note: string | null }): Observable<EnvelopeTransaction>;
