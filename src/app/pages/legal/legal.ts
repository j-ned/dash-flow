...
@Component({
  ...
  template: `
    <nav class="sticky top-0 z-50 border-b border-border bg-canvas" [attr.aria-label]="'legal.navAriaLabel' | transloco">
    ...
    <main class="mx-auto max-w-3xl px-6 py-16 lg:py-24">
      <header>
        <h1 class="text-3xl font-semibold tracking-tight sm:text-4xl">{{ 'legal.title' | transloco }}</h1>
        <p class="mt-3 font-mono text-xs uppercase tracking-[0.16em] text-text-muted">{{ 'legal.updated' | transloco }}</p>
      </header>

      <div class="mt-12 space-y-12 border-t border-border pt-12">
        <section aria-labelledby="legal-editor">
          <h2 id="legal-editor" class="text-xl font-semibold tracking-tight">{{ 'legal.editor.title' | transloco }}</h2>
          <p class="mt-3 text-base leading-relaxed text-text-muted">{{ 'legal.editor.body' | transloco }}</p>
        </section>
        <section aria-labelledby="legal-hosting">
          <h2 id="legal-hosting" class="text-xl font-semibold tracking-tight">{{ 'legal.hosting.title' | transloco }}</h2>
          <p class="mt-3 text-base leading-relaxed text-text-muted">{{ 'legal.hosting.body' | transloco }}</p>
        </section>
        <section aria-labelledby="legal-ip">
          <h2 id="legal-ip" class="text-xl font-semibold tracking-tight">{{ 'legal.ip.title' | transloco }}</h2>
          <p class="mt-3 text-base leading-relaxed text-text-muted">{{ 'legal.ip.body' | transloco }}</p>
        </section>
        <section aria-labelledby="legal-data">
          <h2 id="legal-data" class="text-xl font-semibold tracking-tight">{{ 'legal.data.title' | transloco }}</h2>
          <p class="mt-3 text-base leading-relaxed text-text-muted">{{ 'legal.data.body' | transloco }}</p>
        </section>
        <section aria-labelledby="legal-cookies">
          <h2 id="legal-cookies" class="text-xl font-semibold tracking-tight">{{ 'legal.cookies.title' | transloco }}</h2>
          <p class="mt-3 text-base leading-relaxed text-text-muted">{{ 'legal.cookies.body' | transloco }}</p>
        </section>
        <section aria-labelledby="legal-contact">
          <h2 id="legal-contact" class="text-xl font-semibold tracking-tight">{{ 'legal.contact.title' | transloco }}</h2>
    ...
    <footer class="border-t border-border">
      <div class="mx-auto flex max-w-3xl items-center justify-between gap-4 px-6 py-8 text-sm text-text-muted">
