...
6. **F006** — ⬜ **Ouvert** — Grappe de 7 pages smart > 560 LOC (user-settings, salary-archives, budget-dashboard, loans, envelopes, budget-analytics, landing) au-dessus du seuil maison 200.
7. **F007** — ⬜ **Ouvert** — `recurring-entry-form.ts` 726 LOC : formulaire monolithique, fort churn.
...
10 des 12 constats traités cette session (diff non-committé sur `master`). Restent ouverts : F006, F007.
...
| F006 | ⬜ Ouvert          | Grappe de pages smart > 200 LOC non traitée (refactor L, à piloter par churn).  |
| F007 | ⬜ Ouvert          | `recurring-entry-form.ts` non décomposé (une feature destination-toggle y a été ajoutée par ailleurs).  |
